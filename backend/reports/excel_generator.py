...
COLUMN_CONFIG = [
    ...
    ("ABOGADO_CANONICAL", "ABOGADO (CANÓNICO)", 25),
    ...
    # v8.0: jerarquía organigrama SED (Decretos 544/2021, 048/2022)
    ("DEPENDENCIA_CANONICAL", "DEPENDENCIA (CANÓNICA)", 28),
    ("DIRECCION", "DIRECCIÓN (L1)", 28),
    ("GRUPO", "GRUPO (L2)", 25),
    ("EQUIPO", "EQUIPO (L3)", 20),
    ("CATEGORIA_TEMATICA", "CATEGORÍA TEMÁTICA", 25),
    ("ESTADO", "ESTADO", 10),
    ("FECHA_RESPUESTA", "FECHA RESP.", 13),
    ("SENTIDO_FALLO_1ST", "FALLO 1ra", 18),
    ("FECHA_FALLO_1ST", "FECHA FALLO 1ra", 14),
    ("PARTE_RESOLUTIVA_1ST", "PARTE RESOLUTIVA 1ra", 60),
