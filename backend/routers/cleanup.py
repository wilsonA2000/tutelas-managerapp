...
# (Modernización Fase 7.4) El endpoint POST /api/cleanup/validate-all (validación masiva
# heurística v8.1) se retiró: dependía de `cognition.cognitive_complementary_ai` (motor v8).
# La detección firmante↔accionante / mezcla de radicados la cubre el bibliotecario v9
# (`doc_librarian` → `Document.verificacion`) y los "docs sospechosos" de esta misma página.
