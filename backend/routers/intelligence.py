...
# (Retirado) Los endpoints de similitud semántica (/similar/{id}, /similar-by-text) y el
# módulo backend/ml/embeddings se quitaron: dependían de faiss/BGE-M3 (no instalado) y la
# pestaña "Casos parecidos" se retiró del UI por no aportar al flujo de trabajo.
